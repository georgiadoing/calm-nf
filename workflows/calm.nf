...
// import modules
include {help} from '../bin/help/calm'
include {param_log} from '../bin/log/calm'
...
include{TRIMMOMATIC_TRIM} from '../modules/trimmomatic_trim'
...
workflow RNASEQ {
  ...
  // Step 2: Trimmomatic
  TRIMMOMATIC_TRIM(read_ch)

  // Step 2: Spacer Parser
  //RSEM_ALIGNMENT_EXPRESSION(QUALITY_STATISTICS.out.trimmed_fastq, rsem_ref_files)


  // Step 6: Summary Stats
  RNA_SUMMARY_STATS(TRIMMOMATIC_TRIM.out.trim_stats,
